          ...
          children: [
            Positioned(
              ...
              child: DecorativeGlowCircle(
                  baseSize: 180, color: _brandAccent.withValues(alpha: 0.12)),
            ),
            const Positioned(
              top: -30,
              right: -60,
              child: DecorativeGlowCircle(
                  baseSize: 160, color: Color.fromRGBO(255, 255, 255, 0.06)),
            ),
            Positioned(
              bottom: -80,
              right: -70,
              child: DecorativeGlowCircle(
                  baseSize: 220, color: _brandAccent.withValues(alpha: 0.08)),
            ),
            SafeArea(
              child: Padding(
