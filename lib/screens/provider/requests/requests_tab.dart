    ...
    return Container(
      ...
      child: IntrinsicHeight(
        child: Row(
          ...
          children: [
            Container(width: 5, color: kPrimaryColor),
            Expanded(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const CircleAvatar(radius: 20, backgroundColor: kPrimaryColor, child: Icon(Icons.person, color: Colors.white, size: 20)),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(color: kPrimaryColor.withValues(alpha: 0.12), borderRadius: BorderRadius.circular(20)),
                          child: Text(request.status, style: const TextStyle(color: kPrimaryColor, fontWeight: FontWeight.w700, fontSize: 11.5)),
                        ),
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.location_on_rounded, size: 16, color: kPrimaryColor),
