...
class _ProviderHomeTabState extends State<ProviderHomeTab> {
  ...
  Widget build(BuildContext context) {
    ...
    final firstName =
        username.trim().isEmpty ? null : username.trim().split(' ').first;
    ...
    return Scaffold(
      ...
      appBar: ProviderTabHeader(
        ...
        subtitle: dashboard.isOnline
            ? "You're online and visible to customers"
        ...
        trailing: Material(
          ...
          child: InkWell(
            onTap: () =>
                toggleProviderOnlineStatus(context, !dashboard.isOnline),
            borderRadius: BorderRadius.circular(20),
            child: Padding(
            ...
            children: [
              NotificationsEntryCard(
                onTap: () => Navigator.of(context)
                    .pushNamed(ProviderRoutes.notifications),
              ),
