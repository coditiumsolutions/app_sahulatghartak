...
class AuthCardScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveHeaderHeight =
        headerHeight + (topInset - 20).clamp(0, double.infinity);
    return Scaffold(
        ...
        children: [
          const Positioned(
            ...
            child: DecorativeGlowCircle(
                baseSize: 180, color: Color.fromRGBO(255, 255, 255, 0.08)),
          ),
          const Positioned(
            top: -30,
            right: -60,
            child: DecorativeGlowCircle(
                baseSize: 160, color: Color.fromRGBO(255, 255, 255, 0.08)),
          ),
          SafeArea(
            bottom: false,
            child: Padding(
                ...
                child: Container(
                  ...
                  child: SafeArea(
                    ...
                    child: SingleChildScrollView(
                      padding:
                          EdgeInsets.fromLTRB(24, avatarRadius + 24, 24, 24),
                      child: Column(
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          children: [
            Icon(icon,
                color: selected ? Colors.white : Colors.black45, size: 22),
            const SizedBox(height: 6),
            Text(
              label,
              style: TextStyle(
